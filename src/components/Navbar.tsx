...
const tabs = [
  { id: "welcome", label: "Welcome", bgColor: "bg-[#fdf3f0]", textColor: "text-pink-500", icon: "★" },
  { id: "projects", label: "Projects", bgColor: "bg-[#bff0d3]", textColor: "text-gray-700" },
  { id: "about", label: "About", bgColor: "bg-[#ddd6fe]", textColor: "text-gray-700" },
  { id: "contact", label: "Contact", bgColor: "bg-[#fde68a]", textColor: "text-gray-700" },
];
