export function TornEdge() {
  ...
  // CURVA 2 (BEGE):
  const beigeEdge = "M0,20 C40,23 80,29 120,28 C160,27 200,12 240,14 C280,16 320,33 360,34 C400,35 440,18 480,21 C520,24 560,39 600,37 C640,35 680,15 720,17 C760,19 800,35 840,32 C880,29 920,17 960,19 C1000,21 1040,37 1080,36 C1120,35 1160,15 1200,18 C1240,21 1280,35 1320,33 C1360,31 1400,22 1440,25";
  ...
  return (
    ...
    >
      <svg viewBox="0 0 1440 50" preserveAspectRatio="none" className="w-full h-[40px] sm:h-[50px] md:h-[65px] block">
        ...
        {/* 2. CAMADA BEGE*/}
        <path d={`${beigeEdge} L1440,50 L0,50 Z`} fill="#f2e8da" />
      </svg>
    </div>
  );
}